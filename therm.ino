...
#define FW_VERSION "2.5.3"  // Firmware verzió – 4 relay kimenet (GPIO5, GPIO6, GPIO7, GPIO10)
...
void handleWifiConfig() {
  ...
  html += "<style>";
  html += ".relay-row{display:flex;align-items:center;gap:8px;padding:10px 0;border-bottom:1px solid #333;flex-wrap:nowrap;}";
  html += ".relay-row:last-child{border-bottom:none;}";
